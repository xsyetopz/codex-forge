...
- The checked-in optional MCP standard `assets/optional/mcp-2026-07-28.toml` is enabled canonically in the managed `[features]` section as `mcp_2026_07_28 = true`.
