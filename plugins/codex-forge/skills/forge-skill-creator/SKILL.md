...
description: Use this skill when creating, restructuring, or validating Agent Skills and their metadata, references, scripts, assets, or trigger descriptions. Use another Forge skill for runtime application code or repository governance.
...
- Positive instructions focus execution on the desired state. Use negation for a small number of safety-critical or routing boundaries where the positive alternative alone is ambiguous.
